            ...
            <div className="flex items-start justify-between mb-4">
              <div className="flex-1">
                <div className="flex items-center gap-3 mb-2">
                  <h1 className="text-3xl font-heading font-bold text-neutral-900">{property.title}</h1>
                  <button
                    onClick={(e) => {
                      e.preventDefault();
                    ...
                    className={`p-2 rounded-full transition-colors ${
                      isFavorite ? 'text-accent-600' : 'text-neutral-400 hover:text-accent-600'
                    }`}
              ...
              <div className="text-right ml-4">
                <div className="text-3xl font-heading font-bold text-primary-700 mb-2">
            ...
            {property.available && (
              <div className="flex gap-4 flex-wrap">
                <button
                  ...
                  className="flex-1 min-w-[200px] bg-primary-600 text-white py-3 px-6 rounded-lg font-medium btn-primary"
                >
                  <span className="btn-content">{isAuthenticated ? 'Book Viewing Appointment' : 'Login to Book Viewing'}</span>
                </button>
                <a
                ...
                <button
                  onClick={handleShare}
                  className="px-6 py-3 bg-neutral-200 text-neutral-700 rounded-lg hover:bg-neutral-300 font-medium transition-colors"
                >
                  Share
                </button>
              </div>
